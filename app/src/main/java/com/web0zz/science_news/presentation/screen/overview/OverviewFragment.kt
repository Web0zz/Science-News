package com.web0zz.science_news.presentation.screen.overview
...
import com.web0zz.science_news.presentation.adapter.overview.VideoSlidePagerAdapter
...
import com.web0zz.science_news.presentation.screen.overview.video.VideoFragment
...
class OverviewFragment :
    ...
    private fun closeOverview() = object : ClickActionTypes.OnClickCloseOnOverview {
